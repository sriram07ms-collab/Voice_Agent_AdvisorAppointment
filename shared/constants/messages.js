...
exports.EDUCATIONAL_LINKS = exports.SYSTEM_MESSAGES = void 0;
exports.SYSTEM_MESSAGES = {
    GREET: "Welcome! I'm here to help you schedule an advisor consultation.",
    DISCLAIMER: "Important: This service provides general information only and does not constitute investment advice. Please consult with a qualified financial advisor for personalized investment guidance.",
    ...
    INVESTMENT_ADVICE_REFUSAL: "I cannot provide investment advice. For personalized investment guidance, please consult with a qualified financial advisor. Here are some educational resources: [Educational Links]",
    PII_DETECTED: "For security reasons, please don't share personal information like phone numbers, email addresses, or account numbers during this conversation. We'll collect contact details through a secure link after booking.",
};
exports.EDUCATIONAL_LINKS = {
    'KYC/Onboarding': [
